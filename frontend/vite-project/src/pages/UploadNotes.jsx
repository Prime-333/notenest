...
import { uploadNote, syncUser } from "../services/notesService";
        ...
        <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 text-center">
          <div className="bg-white rounded-3xl border border-gray-100 p-12 max-w-sm w-full">
            ...
            <p className="text-sm text-gray-400">
              Your notes are now live on NoteNest. Redirecting...
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-400">
            Share your handwritten notes with thousands of students
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <p className="text-xs text-gray-400 text-center">
            By uploading, you agree that these notes are your own work and are
            free to share.
          </p>
        </form>
      </div>
